    ...
    <main class="grow flex items-center justify-center p-6 w-full my-8">
        ...
        <div class="w-full max-w-lg bg-[#1D2E28] rounded-3xl shadow-2xl ring-1 ring-white/5 p-8 md:p-10 relative overflow-hidden">
            ...
            <div class="relative z-10">
                ...
                <form action="includes/auth.php" method="POST" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="fullname" id="fullname" required
                                class="block w-full ps-11 p-4 text-gray-100 bg-[#263530] border border-white/5 rounded-2xl placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#066839] focus:bg-[#212f2a] transition-all duration-300"
                                placeholder="Full Name">
                        </div>
                        <span class="text-red-500 text-sm ml-1 nameError hidden">Name must be 3-50 letters</span>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-4 pointer-events-none">
                                <svg class="w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 20 16">
                        ...
                        <span class="text-red-500 text-sm ml-1 emailError hidden">Invalid Email Address</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="space-y-2">
                            ...
                            <input type="password" name="password" id="password" required
                                class="block w-full p-4 text-gray-100 bg-[#263530] border border-white/5 rounded-2xl placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#066839] focus:bg-[#212f2a] transition-all duration-300"
                                placeholder="••••••••">
                        </div>
                    ...
                    <div class="flex flex-col gap-1">
                        <span class="text-red-500 text-sm ml-1 passwordError hidden">Password weak (8+ chars, 1 letter, 1 number)</span>
                        <span class="text-red-500 text-sm ml-1 matchError hidden">Passwords do not match</span>
                    </div>

                    <button type="submit"
                        class="w-full text-white bg-[#066839] border border-[#0A5C36] font-medium rounded-2xl text-lg px-5 py-4 text-center shadow-lg shadow-green-900/30 hover:bg-[#08522e] hover:shadow-green-900/50 hover:-translate-y-0.5 transition-all duration-300 mt-2">
                        Create Account
                    </button>
